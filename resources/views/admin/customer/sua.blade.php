                    ...
                    <div class="portlet light form-fit bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green bold uppercase">Sửa thông tin</span>
                            </div>
                        </div>
                        <div class="portlet-body form">
                            ...
                            @endif
                            <form action="admin/customer/sua/{{$khachhang->id}}" method="POST" class="form-horizontal form-bordered" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-icon right">
                                                <i class="icon-exclamation-sign"></i>
                                                <input type="text" class="form-control" name="gender" value="{{$khachhang->gender}}"> </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-icon right">
                                                <i class="icon-exclamation-sign"></i>
                                                 <input type="text" name="address" value="{{$khachhang->address}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-icon right">
                                                <i class="icon-exclamation-sign"></i>
                                                 <input type="text" name="status" value="{{$khachhang->status}}">
                                            </div>
                                        </div>
                                    </div>
