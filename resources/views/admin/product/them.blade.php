                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light form-fit bordered">
                        ...
                        <div class="portlet-body form">
                            ...
                            @endif
                            <form action="admin/product/them" method="POST" class="form-horizontal form-bordered" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-icon right">
                                                <i class="icon-exclamation-sign"></i>
                                                <input type="file" class="form-control" name="image" id="username2_input"> </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-icon right">
                                                <i class="icon-exclamation-sign"></i>
                                                 <textarea id="ten" class="form-control" name="ten"></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-icon right">
                                                <i class="icon-exclamation-sign"></i>
                                                <input type="text" class="form-control" name="price" id="username2_input"> </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
