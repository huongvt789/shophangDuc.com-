                    ...
                    <div class="portlet light form-fit bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green bold uppercase">Thêm hóa đơn</span>
                            </div>
                        </div>
                        <div class="portlet-body form">
                            ...
                            @endif
                            <form action="admin/order_product/them" method="POST" class="form-horizontal form-bordered" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-icon right">
                                                ...
                                                <input type="text" class="form-control" name="order_note" value="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-icon right">
                                                <i class="icon-exclamation-sign"></i>
                                                <input type="text" class="form-control" name="payment" value=""> </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-icon right">
                                                <i class="icon-exclamation-sign"></i>
                                                 <input type="text" name="order_status" value="">
                                            </div>
                                        </div>
                                    </div>
